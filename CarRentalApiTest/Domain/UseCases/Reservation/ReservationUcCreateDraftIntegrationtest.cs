...
public sealed class ReservationUcCreateDraftIntegrationtest : TestBase, IAsyncLifetime {
   ...
   private IReservationRepository _repo = null!;
   private IUnitOfWork _uow = null!;
   private FakeClock _clock = null!;
   private IReservationUcCreateDraft _sut = null!;
   ...
   public async Task InitializeAsync() {
      ...
      _sut = new ReservationUcCreateDraft(
         _repository: _repo,
         _unitOfWork: _uow,
         _logger: CreateLogger<ReservationUcCreateDraft>(),
         _clock: _clock
      );
   }
   ...
   public async Task ExecuteAsync_success_adds_reservation_and_saves() {
      ...
      var fromDb = await _repo.FindByIdAsync(Guid.Parse(id), CancellationToken.None);
